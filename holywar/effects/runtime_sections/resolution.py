...
class RuntimeResolutionMixin:
    if TYPE_CHECKING:
        ...
        def _validate_manual_target_actions(self, engine: GameEngine, owner_idx: int, actions: list[dict[str, Any]]) -> tuple[bool, str | None]: ...
        def _resolve_targets(self, engine: GameEngine, owner_idx: int, target: TargetSpec) -> list[str]: ...
        def _apply_effect(self, engine: GameEngine, owner_idx: int, source_uid: str, effect: EffectSpec, targets: list[str]) -> None: ...
        def _event_matches(self, event: str, trigger_spec: dict[str, Any]) -> bool: ...
        ...
        def _target_owner_indices(self, engine: GameEngine, target: TargetSpec, owner_idx: int) -> list[int]: ...
        def _get_zone_cards(self, engine: GameEngine, owner_idx: int, zone: str) -> list[str]: ...
