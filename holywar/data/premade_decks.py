...
PREMADE_DECKS: dict[str, dict] = {
    ...
    "phdk_b1_volere": {
        ...
        "cards": [
            ...
            ("Volere di Ph", 1), ("Av'drna", 2), ("Libro di Ya-ner", 2), ("Paradosso di Ykknødar", 1),
    ...
    "phdk_b2_risveglio": {
        ...
        "cards": [
            ...
            ("Paradosso di Ykknødar", 1), ("Maledizione di Ykknødar", 1), ("Risveglio di Ph-Dak'Gaph", 1),
            ("Furia di Llakhnal", 2),
        ],
    },
    "phdk_b3_specchio": {
        "religion": "Ph-DakGaph",
        "name": "B3 - Specchio di Ykknødar",
        "cards": [
            ("Fujn-dar", 3), ("Kah-ok", 3), ("Pkad-nok", 3), ("Ya-ner", 3), ("Sacerdote del Vuoto", 3),
            ...
            ("Distorsione del Reliquiario", 2), ("Libro di Ya-ner", 1), ("Paradosso di Ykknødar", 1),
            ("Specchio di Ykknødar", 1), ("Ykknødar", 1), ("Maledizione di Ykknødar", 1), ("Furia di Llakhnal", 1),
            ("Gggnag'ljep", 1),
        ],
    },
